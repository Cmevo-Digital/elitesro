...
export const metadata: Metadata = {
  title: "Logistică & Servicii Tehnice Evenimente Corporate București",
  description:
   "Soluții complete de logistică și tehnică pentru evenimente corporate în București, Ilfov și Ploiești: mobilier, AV, corturi și bar mobil. Cere ofertă!",
...
const corporateServices = [
   ...
   "Bar mobil echipat și servit la cerere",
...
const technicalSolutions = [
  {
    icon: Music,
    title: "AV & DJ",
    text: "Sisteme audio amplificate, ecrane video și DJ cu echipamente profesionale pentru conferințe, gale și teambuilding-uri.",
   },
   {
    icon: Lightbulb,
    title: "Iluminat tehnic",
    text: "Iluminat ambiental și tehnic, cu LED, efecte și iluminat integrat de scenă pentru evenimente în sală sau outdoor.",
   },
   {
    icon: Tent,
    title: "Corturi & structuri",
    text: "Corturi elegante și structuri montate rapid, pregătite pentru orice vreme, pentru evenimente outdoor în aer liber.",
   },
   {
    icon: Martini,
    title: "Bar mobil",
    text: "Bar mobil complet echipat, servit de personal dedicat la cerere, pentru gale, lansări de produs și evenimente premium.",
   },
];
...
const corporateFaqs = [
  ...
  {
    q: "Ce soluții tehnice puteți pune la dispoziție pentru un eveniment corporate?",
    a: "Oferim un pachet complet de soluții tehnice pentru evenimente corporate: sisteme AV și DJ cu sunet amplificato, iluminat tehnic și ambiental, corturi și structuri pentru evenimente outdoor, precum și bar mobil la cerere. Toate echipamentele sunt testate înainte de eveniment și vin cu asistență tehnică pe toată durata.",
   },
  {
     ...
     <script
      ...
      dangerouslySetInnerHTML={{
        __html: safeStringify(
         eventServiceSchema({
           name: "Logistică & servicii tehnice pentru evenimente corporate",
           description:
            "Soluții complete de logistică și tehnică pentru evenimente corporate în București, Ilfov și Ploiești: mobilier, AV, iluminat, corturi și bar mobil. Solicită ofertă.",
           slug: "corporate",
         }),
        ),
      }}
       ...
       <div className="relative min-h-[55vh] flex items-end overflow-hidden">
         ...
         <div className="relative container-brand pb-14 pt-28">
           ...
           <h1 className="font-display text-4xl md:text-6xl text-white max-w-3xl leading-tight">
            Organizare & Logistică Tehnică Evenimente Corporate în București, Ilfov, Pitești și Ploiești
           </h1>
           <p className="mt-4 text-white/60 font-light max-w-xl">
            Conferințe, gale, teambuilding-uri sau lansări de produs. Asigurăm
            logistica și tehnică — de la AV și iluminat la corturi și bar mobil —
            ca tu să te concentrezi pe conținut.
           </p>
         </div>
       </div>
       ...
       <section className="section-padding bg-white">
         <div className="container-brand">
           <div className="max-w-3xl">
             <p className="overline-text text-gold mb-3">Echipamente</p>
             <h2 className="font-display text-3xl text-obsidian mb-4">
              Soluții tehnice pentru evenimente corporate
             </h2>
             <p className="text-charcoal/60 text-base leading-relaxed font-light">
              Punem la dispoziție un pachet complet de soluții tehnice
              integrate, gata montate și testate înainte de eveniment: AV și DJ,
              iluminat tehnic, corturi și bar mobil. Fiecare echipament vine cu
              suport din partea echipei noastre pe toată durata evenimentului,
              în București, Ilfov, Pitești și Ploiești.
             </p>
           </div>
           <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
             {technicalSolutions.map((item) => {
              ...
              return (
                <div
                 key={item.title}
                 className="bg-ivory p-6 rounded-sm border border-warm-dark"
                >
