  ...
  return (
    <section className="relative section-padding overflow-hidden">
      ...
      <div className="relative z-10 container-brand text-center">
        <AnimatedSection>
          <p className="overline-text text-gold mb-5">Hai să lucrăm împreună</p>
          <h2 className="font-display text-3xl md:text-5xl lg:text-6xl text-white max-w-3xl mx-auto leading-tight">
            Ești la un mesaj distanță de un eveniment impecabil.
          </h2>
          <p className="mt-6 text-white/60 text-base md:text-lg font-light max-w-xl mx-auto">
            Solicită oferta ta gratuită acum. Răspundem în maxim 2 ore în zilele
            lucrătoare.
          </p>
          ...
          <p className="mt-6 text-white/30 text-xs">
            Fără obligații · Fără costuri ascunse · Consultație 100% gratuită
          </p>
        </AnimatedSection>
      </div>
    </section>
