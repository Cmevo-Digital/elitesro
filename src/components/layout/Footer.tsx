...
import { BRAND, NAV_LINKS, SERVICES, WHATSAPP_URL } from "@/lib/constants";
import { Phone, Mail, MapPin } from "lucide-react";

export default function Footer() {
  return (
    <footer className="bg-obsidian text-white">
      <div className="container-brand pt-16 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 pb-12 border-b border-white/10">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="mt-3 text-sm text-white/50 leading-relaxed font-light italic">
              {BRAND.tagline}
            </p>
            <p className="mt-4 text-xs text-white/40 leading-relaxed">
              Partenerul tău premium pentru evenimente impecabile în{" "}
          ...
          {/* Navigation */}
          <div>
            <p className="overline-text text-[10px] text-white/40 mb-5">Navigare</p>
          ...
          {/* Contact */}
          <div>
            <p className="overline-text text-[10px] text-white/40 mb-5">Contact</p>
            <ul className="space-y-4">
              <li>
                ...
                >
                  <Phone
                    size={14}
                    className="mt-0.5 shrink-0 text-gold group-hover:text-gold"
                  />
                  {BRAND.phone}
                </a>
              </li>
